	...
	<div id="sidebar">
		<div class="inner">
			...
			<div class="top_login">
				...
				<a href="" class="xans-element- xans-layout xans-layout-statelogoff">${username }</a>
				<a href="logout"
					class="xans-element- xans-layout xans-layout-statelogoff">로그아웃</a>
				<div class="bt_mypage">
					<a href="">마이페이지 ∨</a>
					<div class="mypage_sub">
						<a href="${contextPath }/ordersDetail">주문조회</a> <a href="">회원정보수정</a> <a href="">관심상품</a> <a
			...
			<div id="category"
				...
				<div>
					<ul>
						<li class="xans-record-"><a href=""><b><font
									color="#ef7b48">BEST 100</font></b></a></li>
						<li class="xans-record-"><a href=""><font color="red"
								class="z">9,900원💰</font></a></li>
						<li class="xans-record-"><a href="${contextPath }/outer">아우터</a></li>
						<li class="xans-record-"><a href="">상의</a></li>
						<li class="xans-record-"><a href="">하의</a></li>
						<li class="xans-record-"><a href="">원피스</a></li>
						<li class="xans-record-"><a href="">코디세트</a></li>
						<li class="xans-record-"><a href="">슈즈/백</a></li>
						<li class="xans-record-"><a href="">이너/잡화</a></li>
						<li class="xans-record-"><a href="">홈&amp;리빙</a></li>
						<li class="xans-record-"><a href=""><b>빠른배송</b>🚛</a></li>
						<li class="xans-record-"><a href="">프리미엄</a></li>
						<li class="xans-record-"><a href="">🕐품절임박</a></li>
					</ul>
					<div
